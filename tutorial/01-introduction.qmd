...
#| fig-cap: "Figure adapted from from Cavaleri (2020). The Figure visualizes different leaf thermoregulation strategies, indicated by the line's slope (see main text for definitions). "
knitr::include_graphics("figures/cavaleri2020cold_fig1.svg")
```
